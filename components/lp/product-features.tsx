    ...
    <AnimatedSection className="bg-white px-4 py-10">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-12 h-12 rounded-full bg-[var(--color-pink-light)] flex items-center justify-center shrink-0">
            <Atom className="w-6 h-6 text-[var(--color-pink-main)]" />
          </div>
        ...
        <p className="text-sm text-[var(--color-text-sub)] leading-relaxed ml-[60px]">
          {"一般的なコラーゲンの1/60サイズまで低分子化。体内への吸収率を徹底的に追求しました。"}
        </p>
        <p className="text-xs text-[var(--color-text-sub)] mt-1 ml-[60px]">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-12 h-12 rounded-full bg-[var(--color-pink-light)] flex items-center justify-center shrink-0">
            <Droplets className="w-6 h-6 text-[var(--color-pink-main)]" />
          </div>
          <h3 className="text-base font-bold text-[var(--color-text)]">
            {"美容サポート成分トリプル配合"}
          </h3>
        </div>
        <div className="flex flex-col gap-3 ml-[60px]">
          {[
      ...
      <div>
        <div className="flex items-center gap-3 mb-3">
          <div className="w-12 h-12 rounded-full bg-[var(--color-pink-light)] flex items-center justify-center shrink-0">
            <Cherry className="w-6 h-6 text-[var(--color-pink-main)]" />
          </div>
          <h3 className="text-base font-bold text-[var(--color-text)]">
            {"毎日おいしく続けられるピーチ味"}
          </h3>
